# taken from MooseX::Types::DateTime/t/01_basic.t
...
isa_ok( find_type_constraint($_), "Mouse::Meta::TypeConstraint" )
    for qw(DateTime DateTime::TimeZone DateTime::Locale);
...
{
    {
        ...
        use Mouse;
        use MouseX::Types::DateTime qw(DateTime Duration);
